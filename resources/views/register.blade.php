...
@section('content')
    <section class="flex flex-col lg:gap-8 items-center">
        <h1 class="text-center">Welcome to AutoHub</h1>
        <form method="POST" enctype="multipart/form-data" action="{{ route('register') }}"
            ...
            <div class="flex lg:flex-row flex-col lg:items-center justify-between w-full">
                ...
                <a href="{{ route('login') }}" class="hover:underline">Already have an account? <span
                        class="text-primary">Login Now</span></a>
            </div>
            @error('register')
        ...
        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="918.58215" height="432.0506"
            ...
            <path d="M564.338,519.92883H326.83353L324.42,482.92l1.53584-3.787,8.9276-21.96927H554.6805l12.07144,24.94747Z"
                transform="translate(-140.70892 -233.9747)" fill="#ccc" />
            ...
            <path
                ...
                transform="translate(-140.70892 -233.9747)" fill="#ffa31a" />
            <path d="M336.34245,461.93066H303.76814v-7.15977a8.73991,8.73991,0,0,1,8.73014-8.73014h23.84417Z"
                transform="translate(-140.70892 -233.9747)" fill="#ccc" />
            ...
            <rect x="136.06773" y="602.08331" width="169.2105" height="1.99958"
                transform="matrix(0.94112, -0.33808, 0.33808, 0.94112, -331.60746, -123.85679)" fill="#3f3d56" />
            ...
            <polygon points="731.758 389.521 721.26 389.521 716.264 349.028 731.758 349.028 731.758 389.521"
                fill="#ffb8b8" />
            <path d="M875.14472,633.67228H841.294v-.42816A13.19085,13.19085,0,0,1,854.47,620.06826h20.67468Z"
                transform="translate(-140.70892 -233.9747)" fill="#2f2e41" />
            <polygon points="867.137 369.628 858.138 375.035 833.001 342.898 846.282 334.918 867.137 369.628"
                fill="#ffb8b8" />
            <path
            ...
            <path
                ...
                transform="translate(-140.70892 -233.9747)" fill="#3f3d56" />
            <circle cx="303.79475" cy="51.81103" r="47.28997" fill="#ffa31a" />
            <polygon
    ...
    <script>
        document.getElementById('check').addEventListener('change', function() {
            ...
            const passwordCField = document.getElementById('password_confirmation');
            const type = passwordField.getAttribute('type') === 'password' ? 'text' : 'password';
            const typeC = passwordCField.getAttribute('type') === 'password' ? 'text' : 'password';
            passwordField.setAttribute('type', type);
            passwordCField.setAttribute('type', type);
        });
    </script>
@endsection
